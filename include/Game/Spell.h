...
{
public:
    ProjectileSpell(Vec2 initialPos, Vec2 target, SpellAssets assets) : Spell({}, 10), m_initialPos(initialPos), m_target(target), m_assets(assets) {
    }
...
public:
    AreaSpell(Vec2 pos, SpellAssets assets) : Spell({}, 10), m_pos(pos), m_assets(assets) {}
	~AreaSpell() {}
